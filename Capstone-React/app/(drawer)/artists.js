...
import { StyleSheet, View, Text, SafeAreaView, Image, ScrollView, TouchableOpacity, RefreshControl, ActivityIndicator } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      {loading && artists.length === 0 ? (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
          ...
          <Text style={{ marginTop: 12, fontSize: 14, color: '#666' }}>Loading artists...</Text>
        </View>
      ) : (
        <ScrollView 
